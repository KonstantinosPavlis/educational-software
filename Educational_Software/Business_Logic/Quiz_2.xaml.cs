...
namespace Educational_Software.Navigation_UI_Pages
{
    ...
    public sealed partial class Quiz_2 : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("OI APANTHSEIS EINAIQuiz2" + user.get_answers().Where(a=>a.section == 2 && a.question!=4).Count());

            List<Answer> answer_list = user.get_answers();
            if (user.get_answers().Count(a => a.section == 2 && a.question == 10) > 0)
            {
                ...
                if (user.get_answers().Count(a => a.section == 2 && (a.question == 21 || a.question == 22)) == 0)
                {
                    question_2_empty.Visibility = Visibility.Collapsed;
                    if (user.get_answers().Count(a => a.section == 2 && a.question == 10 && a.rating == 1f) > 0)
                    {
                        question_2_radio_1.Visibility = Visibility.Visible;
                        question_2_radio_1.IsEnabled = true;
                        question_list.Add(true);
                    }
                    else if (user.get_answers().Count(a => a.section == 2 && a.question == 10 && a.rating == 0.5f) > 0)
                    {
                ...
                else if (user.get_answers().Count(a => a.section == 2 && (a.question == 31 || a.question == 32 || a.question == 33)) == 0)
                {
                    question_2_empty.Visibility = Visibility.Collapsed;
        ...
        private void Next_step(object sender, RoutedEventArgs e)
        {
            ...
            if (current_question_number == 1)
            {
                ...
                if ((bool)question_1_radio_answer2.IsChecked && time_period_seconds < answer_timer)
                {
                    question_2_radio_1.Visibility = Visibility.Visible;
                    question_2_radio_1.IsEnabled = true;
                    question_list.Add(true);
                    user.answer(2, 10, time_period_seconds, 1f, true);
                }
                else if ((bool)question_1_radio_answer2.IsChecked && time_period_seconds >= answer_timer)
                {
                    question_2_radio_2.Visibility = Visibility.Visible;
                    question_2_radio_2.IsEnabled = true;
                    question_list.Add(true);
                    time_delay++;
                    user.answer(2, 10, time_period_seconds, 0.5f, true);
                }
                else
                {
                    question_2_radio_2.Visibility = Visibility.Visible;
                    question_2_radio_2.IsEnabled = true;
                    question_list.Add(false);
                    user.answer(2, 10, time_period_seconds, 0f, false);
                }
            ...
            else if (current_question_number == 2)
            {
                ...
                {
                    if ((bool)question_2_radio1_answer1.IsChecked && time_period_seconds < answer_timer)
                    {
                        question_3_radio_1.Visibility = Visibility.Visible;
                        question_3_radio_1.IsEnabled = true;
                        question_list.Add(true);
                        user.answer(2, 21, time_period_seconds, 1f, true);
                    }
                    else if ((bool)question_2_radio1_answer1.IsChecked && time_period_seconds >= answer_timer)
                    {
                        question_3_radio_2.Visibility = Visibility.Visible;
                        question_3_radio_2.IsEnabled = true;
                        question_list.Add(true);
                        time_delay++;
                        user.answer(2, 21, time_period_seconds, 0.5f, true);
                    }
                    else
                    {
                        question_3_radio_2.Visibility = Visibility.Visible;
                        question_3_radio_2.IsEnabled = true;
                        question_list.Add(false);
                        user.answer(2, 21, time_period_seconds, 0f, false);
                    }
                }
                else
                {
                    question_2_radio_2.IsEnabled = false;
                    if ((bool)question_2_radio2_answer3.IsChecked && time_period_seconds < answer_timer)
                    {
                        question_3_radio_2.Visibility = Visibility.Visible;
                        question_3_radio_2.IsEnabled = true;
                        question_list.Add(true);
                        user.answer(2, 22, time_period_seconds, 1f, true);
                    }
                    else if ((bool)question_2_radio2_answer3.IsChecked && time_period_seconds >= answer_timer)
                    {
                        question_3_radio_3.Visibility = Visibility.Visible;
                        question_3_radio_3.IsEnabled = true;
                        question_list.Add(true);
                        time_delay++;
                        user.answer(2, 22, time_period_seconds, 0.5f, true);
                    }
                    else
                    {
                        question_3_radio_3.Visibility = Visibility.Visible;
                        question_3_radio_3.IsEnabled = true;
                        question_list.Add(false);
                        user.answer(2, 22, time_period_seconds, 0f, false);
                    }
                }
            ...
            else if (current_question_number == 3)
            {
                ...
                if (question_list[0] == true && question_list[1] == true && time_delay == 0)
                {
                    ...
                    {
                        question_list.Add(true);
                        user.answer(2, 31, time_period_seconds, 1f, true);
                    }
                    else if ((bool)question_3_radio1_answer1.IsChecked && time_period_seconds >= answer_timer)
                    {
                        question_list.Add(true);
                        time_delay++;
                        user.answer(2, 31, time_period_seconds, 0.5f, true);
                    }
                    else
                    {
                        question_list.Add(false);
                        user.answer(2, 31, time_period_seconds, 0f, false);
                    }
                }
                else if ((question_list[0] == true && question_list[1] == false) || (question_list[0] == false && question_list[1] == true) || (question_list[0] == true && question_list[1] == true && time_delay == 1))
                {
                    ...
                    {
                        question_list.Add(true);
                        user.answer(2, 32, time_period_seconds, 1f, true);
                    }
                    else if ((bool)question_3_radio2_answer2.IsChecked && time_period_seconds >= answer_timer)
                    {
                        question_list.Add(true);
                        time_delay++;
                        user.answer(2, 32, time_period_seconds, 0.5f, true);
                    }
                    else
                    {
                        question_list.Add(false);
                ...
                {
                    if ((bool)question_3_radio3_answer1.IsChecked && time_period_seconds < answer_timer)
                    {
                        question_list.Add(true);
                        user.answer(2, 33, time_period_seconds, 1f, true);
                    }
                    else if ((bool)question_3_radio3_answer1.IsChecked && time_period_seconds >= answer_timer)
                    {
                        question_list.Add(true);
                        time_delay++;
                        user.answer(2, 33, time_period_seconds, 0.5f, true);
                    }
                    else
                    {
                        question_list.Add(false);
                        user.answer(2, 33, time_period_seconds, 0f, false);
                    }
                }
                ...
                else
                {
                    ...
                    mainWindow.test_2_nav.Visibility = Visibility.Visible;
                    info_message.Severity = InfoBarSeverity.Success;
                    info_message.Title = "Επιτυχία";
                    info_message.Message = "Συγχαρητήρια! Περάσατε τη δοκιμασία !";
                    current_question_number = 11;
